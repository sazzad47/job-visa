  ...
  return (
    <React.Fragment>
      ...
      <div className='visa-form-input'>
        <TextField name='passportCountry' onChange={handleInput} required fullWidth label="Country" variant="outlined" />
      </div>
      <div className='visa-form-input'>
        <TextField name='passportNumber' onChange={handleInput} required fullWidth label="Passport Number" placeholder='Enter your passport number' variant="outlined" />
      </div>
      <div className='visa-form-input'>
        <TextField name='passportIssuingAuthority' onChange={handleInput} required fullWidth label="Issuing Authority" variant="outlined" />
      </div>
