              ...
              <ul className={boxApplyClassSubMenu.join(" ")}>
                <li>
                  ...
                  <Link href="/apply/visa">
                    <a onClick={toggleClass}>Apply for Visa</a>
                  </Link>{" "}
                </li>
                <li>
                  <Link href="/apply/jobs">
                    <a onClick={toggleClass}>Apply for Job</a>
                  </Link>{" "}
                </li>
                <li>
                  <Link href="/apply/visaLoan">
                    <a onClick={toggleClass}>Apply for Loan</a>
                  </Link>{" "}
                </li>
              </ul>
            </li>
              ...
              <ul className={boxCheckingClassSubMenu.join(" ")}>
                <li>
                  ...
                  <Link href="/checking/visa">
                    <a onClick={toggleClass}>Visa Checking</a>
                  </Link>{" "}
                </li>
                <li>
                  <Link href="/checking/job">
                    <a onClick={toggleClass}>Job Checking</a>
                  </Link>{" "}
                </li>
                <li>
                  <Link href="/checking/loan">
                    <a onClick={toggleClass}>Loan Checking</a>
                  </Link>{" "}
                </li>
              </ul>
            </li>
