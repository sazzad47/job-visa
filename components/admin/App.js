...
const App = () => {
  return (
    ...
    >
      <Resource
        name="visaApplicants"
        list={VisaApplicatioinList}
        show={VisaApplicationShow}
        options={{ label: "Visa Applicants" }}
      />
      <Resource
        name="loanApplicants"
        list={LoanApplicatioinList}
        show={LoanApplicationShow}
        options={{ label: "Loan Applicants" }}
      />
      <Resource
        name="jobApplicants"
        list={JobApplicatioinList}
        show={JobApplicationShow}
        options={{ label: "Job Applicants" }}
      />
      <Resource
        name="jobs"
        list={JobList}
      ...
      <CustomRoutes>
        ...
        <Route
          path="/cookies/edit"
          element={<EditCookies pageName="cookies" />}
        />
        <Route path="/policies" element={<Policies pageName="policies" />} />
        <Route
          path="/policies/edit"
          element={<EditPolicies pageName="policies" />}
        />
        ...
        <Route
          path="/legalNotice"
          element={<LegalNotice pageName="legalNotice" />}
        />
        <Route
          path="/legalNotice/edit"
          element={<EditLegalNotice pageName="legalNotice" />}
        />
        <Route
          path="/accessibilityStatement"
          element={<AccessibilityStatement pageName="accessibilityStatement" />}
        />
        <Route
          path="/accessibilityStatement/edit"
          element={
            <EditAccessibilityStatement pageName="accessibilityStatement" />
          }
        />
      </CustomRoutes>
    </Admin>
