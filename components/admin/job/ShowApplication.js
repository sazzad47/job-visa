...
const VisaApplicationShow = props => (
    ...
    <Show {...props} title={<ApplicationTitle/>} actions={<ApplicationActions/>}>
        ...
        <SimpleShowLayout id="exportToPDF">
            ...
            <TextField Lable = "Issuing Authority" source="passportIssuingAuthority"/>
            ...
            <TextField Lable = "Name of the country you wish to visit" source="wishedCountry"/>
            ...
            <TextField Lable = "How many months/years do you want to stay?" source="wishedStayDuration"/>
            <TextField Lable = "Do you want to be citizen there?" source="isWishingCitizenship"/>
            <Typography variant="h6" sx={{fontWeight: 'medium'}}>Home Information</Typography>
            <TextField Lable = "Located at the home address?" source="locatedAtHome"/>
            <TextField Lable = "Street Address" source="homeStreetAddress"/>
            <TextField Lable = "Street Address Line 2" source="homeStreetAddressLine2"/>
            ...
            <TextField Lable = "How long you are in this address?" source="homeStayDuration"/>
            <TextField Lable = "Who does your family depend on?" source="familyDependentOn"/>
            <TextField Lable = "What do you do now?" source="currentJob"/>
            <TextField Lable = "How much is your monthly income?" source="monthlyIncome"/>
            <TextField Lable = "How many people are in your family?" source="familyMember"/>
            <TextField Lable = "Educational Qualification" source="educationalQualification"/>
            <TextField Lable = ">How many languages do you know?" source="languages"/>
