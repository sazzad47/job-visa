...
export const MyMenu = () => (
    <Menu>
        ...
        <Menu.Item to="/policies" primaryText="Privacy Policy" leftIcon={<PolicyIcon />}/>
        <Menu.Item to="/help" primaryText="Help & Support" leftIcon={<SupportIcon />}/>
        <Menu.Item to="/about" primaryText="About" leftIcon={<InfoIcon />}/>
        <Menu.Item to="/legalNotice" primaryText="Legal Notice" leftIcon={<EmergencyShareIcon />}/>
        <Menu.Item to="/accessibilityStatement" primaryText="Accessibility Statement" leftIcon={<DocumentScannerIcon />}/>
