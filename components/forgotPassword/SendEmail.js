  ...
  return (
    <div className='verify-form'>    
          ...
          <div className='verify-header'>
            <div className='text-center mb-3'><LockResetIcon/></div>
            {codeForm?
              <>
            <Typography align='center'>Verify your email</Typography>
            <Typography align='center' style={{fontSize:'12px', marginTop:'1rem'}}>
            ...
            <Typography align='center' style={{fontSize:'12px', marginTop:'1rem'}}>
              That's okay, it happens! Enter your email address below to reset your password.
            </Typography>
            </>
            }
            </div>
            <form onSubmit={codeForm? handleVerify : handleSendOtp}>
              ...
              required/>
              {codeForm?
              <div className='text-center'><button type="submit" className='submit-btn'>{verifying? <span className="checking-effect">Verifying...</span> : 'Verify'}</button></div>
              : 
              <div className='text-center'>
                <button type="submit" className='submit-btn'>{sending? <span className="checking-effect">Sending...</span> : 'Send OTP'}</button>
              </div>
              }
