  ...
  return (
    <div className='verify-form'>    
          ...
          <div className='verify-header-success'>
            <div className='text-center mb-3'><CheckCircleOutlineIcon/></div>
            
            <Typography align='center'>Password changed successfully!</Typography>
            <Typography align='center' style={{fontSize:'12px', marginTop:'1rem'}}>
              ...
              <div className='text-center'>
                <Link href="/auth"><button className='login-btn-success'>Login</button></Link>
              </div>
          ...
          <div className='verify-header'>
            ...
            <form onSubmit={handleSubmit} className="mx-5">
              ...
              <div className='text-center'>
                <button type="submit" className='submit-btn'>{resetting? <span className="checking-effect">Resetting...</span> : 'Reset'}</button>
              </div>
